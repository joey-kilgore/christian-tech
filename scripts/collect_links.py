...
TYPES = ["Bible Software","Bible","Prayer","Bible Memory","Christian Content"]
...
def write_df_to_markdown(df, filename):
...
def main():
  ...
  SAMPLE_RANGE_NAME = "Links!A:H" # grab the entire sheet
  creds = None
  ...
  try:
    ...
    write_df_to_markdown(df,"./source/links.md")
